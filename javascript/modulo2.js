...
for (propiedad in ejercicio2){
  ...
  */
  if(Array.isArray(ejercicio2[propiedad])){
    console.log(`la propiedad ${propiedad} es un array, a continuacion recorremos sus elementos`)
    /*
    ...
    */
    if(typeof ejercicio2[propiedad] === "object"){
      ...
      */
      console.log(`la propiedad ${propiedad} es un objeto, a continuacion recorremos sus propiedades y valores`);
      /*
      ...
      */
      for (propiedad2 in ejercicio2[propiedad]){
        ...
        */
        console.log(`La propiedad ${propiedad2} tiene como valor ${ejercicio2[propiedad][propiedad2]}`);
      }
    } else {
      /*
      ...
      */
      console.log(`La propiedad ${propiedad} tiene como valor ${ejercicio2[propiedad]}`);
    }
  }
}
/*
